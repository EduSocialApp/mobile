import { ScrollView, View, TextInput, TouchableOpacity, Alert, Text } from 'react-native'
                ...
                <View className="flex-1 items-center flex-row" style={{ gap: 14 }}>
                    ...
                    <Controller
                        ...
                        render={({ field: { value, onChange } }) => {
                            ...
                            return (
                                <TouchableOpacity className="flex-row items-center" style={{ gap: 4 }} onPress={() => setValue('level', nextState)}>
